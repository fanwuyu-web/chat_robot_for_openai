...
static int __Pyx_modinit_type_init_code(void) {
  ...
  __pyx_type___pyx_array.tp_#print = 0;
  #endif
  ...
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type___pyx_MemviewEnum.tp_#print = 0;
  #endif
  ...
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type___pyx_memoryview.tp_#print = 0;
  #endif
  ...
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type___pyx_memoryviewslice.tp_#print = 0;
  #endif
...
/* CheckBinaryVersion */
  static int __Pyx_check_binary_version(void) {
    ...
    PyOS_sn#printf(ctversion, 5, "%d.%d", PY_MAJOR_VERSION, PY_MINOR_VERSION);
    found_dot = 0;
    for (i = 0; i < 4; i++) {
        if (!ctversion[i]) {
    ...
    if (!same) {
        ...
        PyOS_sn#printf(message, sizeof(message),
